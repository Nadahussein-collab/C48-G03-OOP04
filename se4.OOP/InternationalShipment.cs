...
namespace se4.OOP
{
    public class InternationalShipment : Shipment, ITrackable, IInsurable
    {
        ...
        public InternationalShipment(string trackingCode, string description, decimal weight, decimal deliveryFee, DeliveryAdress destination, string destinationCountry, decimal customsFee)
